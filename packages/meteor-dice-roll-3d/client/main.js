...
function dice_initialize(container, w, h) {
   ...
   // $t.bind(set, 'blur', function(ev) { $t.set(container, { class: 'svg' }); });
    ...
    box.bind_throw($t.id('roll4'), { set: ['d4']}, before_roll, after_roll);
	box.bind_throw($t.id('roll6'), { set: ['d6']}, before_roll, after_roll);
	box.bind_throw($t.id('roll8'), { set: ['d8']}, before_roll, after_roll);
